...
const result = { expected: 121, required: required.length, present: files.length, bytes: total, missing, invalid, unused };
...
if (required.length !== 121 || missing.length || invalid.length || unused.length || total > 9535000) process.exitCode = 1;
