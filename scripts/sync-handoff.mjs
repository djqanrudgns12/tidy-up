...
const assets = required.map(a => {
  ...
  const status = a.kind === 'thumbnail'
    ? (a.id === 'classroom-cabinet--thumbnail' && delivered && r?.status !== 'reviewed-composition' ? 'draft-replace' : delivered ? 'delivered' : 'needs-composition')
